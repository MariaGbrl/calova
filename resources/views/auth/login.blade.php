...
<head>
	...
	<title>Login</title>
        ...
        <link type="text/css" href="http://calova.id/minset/bootstrap/css/bootstrap.min.css" rel="stylesheet">
        <link type="text/css" href="http://calova.id/minset/bootstrap/css/bootstrap-responsive.min.css" rel="stylesheet">
        <link type="text/css" href="http://calova.id/minset/css/theme.css" rel="stylesheet">
        <link type="text/css" href="http://calova.id/minset/images/icons/css/font-awesome.css" rel="stylesheet">
	...
	<div class="wrapper">
		<div class="container">
			<div class="row">
				...
				<form class="form-vertical" method="POST" action="/auth/login">
					{!! csrf_field() !!}
